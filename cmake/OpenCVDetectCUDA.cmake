...
if(HIP_FOUND)
  ...
  macro(ocv_cuda_compile VAR)
    ...
    if (${HIP_PLATFORM} MATCHES "nvcc")
    	INCLUDE_DIRECTORIES("/opt/rocm/hip/include/" "/usr/local/cuda/include/" "/opt/rocm/hipblas/include" "/opt/rocm/rocfft/include")
    	LINK_DIRECTORIES("/opt/rocm/hip/lib/" "/usr/local/cuda/lib64/" "/opt/rocm/hipblas/lib" "/opt/rocm/rocfft/lib" )
    	ADD_DEFINITIONS(-D__HIP_PLATFORM_NVCC__ )
    elseif (${HIP_PLATFORM} MATCHES "hcc")
        INCLUDE_DIRECTORIES("/opt/rocm/hip/include/hcc_details" "/opt/rocm/include/" "/opt/rocm/hip/include/" "/opt/rocm/hipblas/include" "/opt/rocm/rocfft/include")
        LINK_DIRECTORIES("/opt/rocm/hip/lib/" "/opt/rocm/hipblas/lib" "/opt/rocm/rocfft/lib")
...
if(HAVE_HIP)
  ...
  ELSEIF(${HIP_PLATFORM} MATCHES "hcc")
    ...
    set(CUDA_LIBRARIES "hip_hcc" "hipblas" "rocfft" )
  ENDIF()
  ...
  if(HAVE_HIPBLAS)
    set(HIP_hipblas_LIBRARY_ABS ${HIP_hipblas_LIBRARY})
    ocv_convert_to_lib_name(HIP_hipblas_LIBRARY ${HIP_hipblas_LIBRARY})
  endif()

  if(HAVE_ROCFFT)
    set(HIP_rocfft_LIBRARY_ABS ${HIP_rocfft_LIBRARY})
    ocv_convert_to_lib_name(HIP_rocfft_LIBRARY ${HIP_rocfft_LIBRARY})
  endif()
endif()
